...
echo -e "....... ${bold}${white}$symbol${reset} ... $price ... $changePctHour $changePct $THREd $SEVENd  $ONEm  $THREm  $SIXm   ....... $holding     =     ${blue}$value${reset}"; 
...
MENU () {
echo -e "   [enter] - Refresh Price | [h] - Help | [q] - Quit"
echo;
echo -n "   : "
read next
...
HELP () {
    ...
    echo -e "   ----"
    echo;
    echo -e "   [a] - Add Coin / [d] - Delete Coin";
    echo -e "         Portfolio Value:"
    echo -e "   [P] - Visible - [p] Hidden"
    echo -e "   [q] - Quit"
    echo;echo;echo;
    MENU
}
